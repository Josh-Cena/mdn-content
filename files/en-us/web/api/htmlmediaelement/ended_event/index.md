...
- The `AudioScheduledSourceNode` [`ended`](/en-US/docs/Web/API/AudioScheduledSourceNode/ended_event) event
- The `MediaStreamTrack` [`ended`](/en-US/docs/Web/API/MediaStreamTrack/ended_event) event
